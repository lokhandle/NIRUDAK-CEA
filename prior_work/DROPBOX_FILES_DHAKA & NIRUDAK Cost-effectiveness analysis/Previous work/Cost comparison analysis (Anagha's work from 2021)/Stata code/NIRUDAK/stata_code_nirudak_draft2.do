/*note: 'NIRUDAK' & 'Model6' are used interchangeably in this code and refer to hypothetical costs from the NIRUDAK model. 'actual' and 'gold standard' are also used interchangeably.
