...
ICER_fxn <- function(death_gvn_overtreat_prob, death_gvn_undertreat_prob) {
  ...
  # death from undertreatment given Severe
  mean_DALYs_lost_if_die_branch_d <- 58.99
  mean_DALYs_lost_if_die_branch_g <- 64.02
  # death from undertreatment given Some
  mean_DALYs_lost_if_die_branch_h <- 56.61046
  ...
  # death from undertreatment given Some
  mean_DALYs_lost_if_die_branch_q <- 46.11102
  ...
  # replace 0 when running one-way for Some undertreatment
  branch_h_DALY <- 0*mean_DALYs_lost_if_die_branch_h
  branch_i_DALY <- 0
  ...
  branch_q_DALY <- 0*mean_DALYs_lost_if_die_branch_q
  branch_r_DALY <- 0
